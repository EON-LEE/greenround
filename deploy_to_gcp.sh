...
# =============================================================================
# Greenround - Google Cloud 수동 배포 스크립트
# =============================================================================
# [주의!] 이 스크립트는 더 이상 주 배포 방법이 아닙니다.
#
# 이 프로젝트의 주 배포는 GitHub의 'main'/'develop' 브랜치로 코드를 push하면
# Cloud Build에 의해 자동으로 트리거됩니다.
#
# 이 스크립트는 다음과 같은 특수한 경우에만 사용하세요:
#   - 로컬 환경에서 빠른 테스트 배포가 필요한 경우
#   - CI/CD 파이프라인에 문제가 발생했을 때의 비상 배포
# =============================================================================
